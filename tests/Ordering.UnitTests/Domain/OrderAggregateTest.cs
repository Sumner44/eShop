...
public class OrderAggregateTest
{
    ...
    public void Add_new_Order_raises_new_event()
    {
        ...
        //Act 
        var fakeOrder = new Ordering.Domain.AggregatesModel.OrderAggregate.Order("1", "fakeName", new Address(street, city, state, country, zipcode), cardTypeId, cardNumber, cardSecurityNumber, cardHolderName, cardExpiration);
    ...
    {
        // Arrange
        var testorder = new Ordering.Domain.AggregatesModel.OrderAggregate.Order();
